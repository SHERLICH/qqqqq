/**
 * - 无构建：逻辑对齐 `home.mjs`（由 `index.html` + serve 使用）。
 * - Vite：与 `App.jsx`、`vite-app/index.html` 一起使用，运行 `npm run dev:spa`。
 */
        ...
        <div className="mx-auto flex h-14 max-w-lg items-center justify-between px-4">
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              <span className="absolute right-2 top-2 h-2 w-2 rounded-full bg-red-500 ring-2 ring-white/70" />
            </button>
          </div>
        </div>
      </header>
                ...
                >
                  ...
                  <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-3 text-slate-500">
                    ...
                    >
                      ...
                      />
                      <span className={liked ? "font-medium text-slate-800" : ""}>
                        {count}
                      </span>
                    </button>
